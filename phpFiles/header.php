...
<head>
    <meta charset="utf-8">
    <!-- COMP212 Assignment 2 Talitha van Lith August 2018 Student ID: vanta342 8078082-->
    <!-- Header for Hotel Thaleias website-->
    <title>Hotel Thaleias</title>
...
<nav>
    <ul class="nav">
        <?php
        //get current page to check which page is active
