var room_options = (function(){
    ...
    /**
     * Displays all available rooms during the dates selected by the user.
     */
    function parseRooms(data, target) {
        ...
        $(target).after("<section class=\"bookedAdmin\">" + text+ "</section>");
    ...
    /**
     * Opens availableRooms and calls the parseRooms function to display them.
     */
    function showRooms() {
    ...
    /**
     * Prints error messages of the dates selected.
     */
    ...
    /**
     * Verifies that the dates selected are valid.
     */
    ...
    /**
     * Gets the selected dates from the form and calls the verifyDates function.
     */
    function getDates() {
        var messages = [];
